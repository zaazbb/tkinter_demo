...
w.wm_title('Canvas Item Demonstration')
w.wm_iconname('Items')
positionWindow(w)
...
c = Canvas(frame, scrollregion='0c 0c 30c 24c', width='15c', height='10c',
           relief='sunken', borderwidth=2)
...
c.grid(in_=frame, row=0, column=0, rowspan=1, columnspan=1, sticky='news')
vscroll.grid(row=0, column=1, rowspan=1, columnspan=1, sticky='news')
hscroll.grid(row=1, column=0, rowspan=1, columnspan=1, sticky='news')
...
c.create_line('1c 1c 3c 1c 1c 4c 3c 4c', width='2m', fill=blue,
              cap='butt', join='miter', tags='item')
c.create_line('4.67c 1c 4.67c 4c', arrow='last', tags='item')
c.create_line('6.33c 1c 6.33c 4c', arrow='both', tags='item')
c.create_line('5c 6c 9c 6c 9c 1c 8c 1c 8c 4.8c 8.8c 4.8c 8.8c 1.2c '
              '8.2c 1.2c 8.2c 4.6c 8.6c 4.6c 8.6c 1.4c 8.4c 1.4c 8.4c 4.4c',
              width=3, fill=red, tags='item')
c.create_line('1c 5c 7c 5c 7c 7c 9c 7c', width='.5c',
              stipple='@'+os.path.join(tk_demoDirectory, 'images', 'gray25.xbm'),
              arrow='both', arrowshape='15 15 7', tags='item')
c.create_line('1c 7c 1.75c 5.8c 2.5c 7c 3.25c 5.8c 4c 7c', width='.5c',
              cap='round', join='round', tags='item')
...
c.create_line('11c 4c 11.5c 1c 13.5c 1c 14c 4c', smooth='on',
              fill=blue, tags='item')
c.create_line('15.5c 1c 19.5c 1.5c 15.5c 4.5c 19.5c 4c', smooth='on',
              arrow='both', width=3, tags='item')
c.create_line('12c 6c 13.5c 4.5c 16.5c 7.5c 18c 6c '
              '16.5c 4.5c 13.5c 7.5c 12c 6c',
              smooth='on', width='3m', cap='round',
              stipple='@'+os.path.join(tk_demoDirectory, 'images', 'gray25.xbm'),
              fill=red, tags='item')
...
c.create_polygon ('21c 1.0c 22.5c 1.75c 24c 1.0c 23.25c 2.5c '
	'24c 4.0c 22.5c 3.25c 21c 4.0c 21.75c 2.5c', fill=green, 
	outline='black', width='4', tags='item')
c.create_polygon ('25c 4c 25c 4c 25c 1c 26c 1c 27c 4c 28c 1c '
	'29c 1c 29c 4c 29c 4c', fill=red, smooth='on', tags='item')
c.create_polygon ('22c 4.5c 25c 4.5c 25c 6.75c 28c 6.75c '
	'28c 5.25c 24c 5.25c 24c 6.0c 26c 6c 26c 7.5c 22c 7.5c',
	stipple='@'+os.path.join(tk_demoDirectory, 'images', 'gray25.xbm'),
	outline='black', tags='item')
...
c.create_rectangle ('1c 9.5c 4c 12.5c', outline=red, width='3m', tags='item')
c.create_rectangle ('0.5c 13.5c 4.5c 15.5c', fill=green, tags='item')
...
c.create_oval ('11c 9.5c 14c 12.5c', outline=red, width='3m', tags='item')
c.create_oval ('10.5c 13.5c 14.5c 15.5c', fill=green, tags='item')
...
c.create_text ('22.5c 9c', anchor='n', font=font1, width='4c', 
	text="A short string of text, word-wrapped, justified left, and anchored north (at the top).  The rectangles show the anchor points for each piece of text.", tags='item')
c.create_rectangle ('25.4c 10.9c 25.6c 11.1c')
c.create_text ('25.5c 11c', anchor='w', font=font1, fill=blue, 
	text="Several lines,\n each centered\nindividually,\nand all anchored\nat the left edge.",
	justify='center', tags='item')
c.create_rectangle ('24.9c 13.9c 25.1c 14.1c')
c.create_text ('25c 14c', font=font2, anchor='c', fill=red, angle='15', 
	text="Angled characters", tags='item')
...
c.create_arc ('0.5c 17c 7c 20c', fill=green, outline='black', 
	start='45', extent='270', style='pieslice', tags='item')
c.create_arc ('6.5c 17c 9.5c 20c', width='4m', style='arc', 
	outline=blue, start='-135', extent='270', tags='item', 
	outlinestipple='@'+os.path.join(tk_demoDirectory, 'images', 'gray25.xbm'))
...
ousterhout = PhotoImage(
        file=os.path.join(tk_demoDirectory, 'images', 'ouster.png')) 
active = PhotoImage(
...
c.create_bitmap ('17c 21.5c', tags='item', 
	bitmap='@'+os.path.join(tk_demoDirectory, 'images', 'letters.xbm'))
...
def butPress(w, color):
    i = w.create_text('25c 18.1c', text="Oooohhh!!", fill=color, anchor='n')
    w.after(500, lambda: w.delete(i))
...
scale = Scale(c, from_='0', to='100', length='6c', sliderlength='.4c', 
	width='.5c', tickinterval='0')
