...
w.wm_title('Text Demonstration - Basic Facilities')
w.wm_iconname('text')
positionWindow(w)
...
def fontchooserToggle():
    pass
fontchooser = ttk.Button(w, text='111')
btns = addSeeDismiss(w, demo_name, extra=fontchooser)
...
text = Text(w, setgrid=1, height=30, undo=1, autosep=1)
...
if root._windowingsystem == 'win32':
    text.insert('end', "Control-y")
else:
    text.insert('end', "Control-Shift-z")
...
text.insert('end', """ redoes undone edits.
